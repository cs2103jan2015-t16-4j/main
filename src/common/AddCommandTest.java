...
public class AddCommandTest {
	...
	/* Non recurring: AddCommand(String name, Calendar startTime, Calendar endTime) */
	/* Recurring: AddCommand(String name, String recurringCycle, Calendar startTime,
	...
	public void addRecurringTimeTaskTest() {
		...
		AddCommand a = new AddCommand("update manual", "weekly", startTime ,endTime, endRecurringTime);
		ArrayList<Task> result = a.execute();
		assertEquals(1,result.size());
		assertEquals("update manual",result.get(0).getName());
		assertEquals(startTime,result.get(0).getStartTime());
	...
	public void addRecurringDeadlineTaskTest() {
		...
		AddCommand a = new AddCommand("update manual", "daily", null ,deadLine, endRecurringTime);
		ArrayList<Task> result = a.execute();
